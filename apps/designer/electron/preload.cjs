...
contextBridge.exposeInMainWorld("forgeuiDesktop", {
  ...
  deleteImage: (args) => ipcRenderer.invoke("project:deleteImage", args),
  deleteFont: (args) => ipcRenderer.invoke("project:deleteFont", args),
  pruneOrphanImages: (args) => ipcRenderer.invoke("project:pruneOrphanImages", args ?? {}),
  ...
  moveNode: (args) => ipcRenderer.invoke("project:moveNode", args),
  ...
  getSnapshotPreview: (id) => ipcRenderer.invoke("project:getSnapshotPreview", id),
  deleteSnapshot: (id) => ipcRenderer.invoke("project:deleteSnapshot", id),
  ...
  listAiHosts: () => ipcRenderer.invoke("ai:listHosts"),
  installAiEnv: (args) => ipcRenderer.invoke("ai:installEnv", args ?? {}),
  uninstallAiEnv: (args) => ipcRenderer.invoke("ai:uninstallEnv", args ?? {}),
  setAiCustomPath: (args) => ipcRenderer.invoke("ai:setCustomPath", args ?? {}),
  pickAiCustomPath: (args) => ipcRenderer.invoke("ai:pickCustomPath", args ?? {}),
  launchAiHost: (args) => ipcRenderer.invoke("ai:launchHost", args ?? {}),
  onAiModelUpdated: (cb) => {
