...
message(STATUS "Don't use neon on simulator")
else()
if ((DEFINED CONFIG_CHIPSET_QM10XH) AND (DEFINED CONFIG_OS_RTT))
set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -mfloat-abi=hard -mfpu=neon-vfpv4")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mfloat-abi=hard -mfpu=neon-vfpv4")
else()
if(CONFIG_CHIPSET_QM10XV OR CONFIG_CHIPSET_QM10XH)
set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -mfloat-abi=hard -mfpu=neon -march=armv7-a")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mfloat-abi=hard -mfpu=neon -march=armv7-a")
endif()
endif()
endif()
...
# Ensure LVGL is built as position-independent code (PIC).
...
target_include_directories(lvgl PUBLIC ${XOS_INTERFACE_INC}
	...
	${XOS_ROOT}/core/package/libnative/qlibpng/include
        ...
        ${XOS_ROOT}/core/package/libnative/qlibquamedia/qua_gui_accel/include
        ${XOS_ROOT}/core/package/libnative/qlibquamedia/quagl_adapter/include
)
